.class public Lorg/slim/utils/ShortcutPickerHelper;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/slim/utils/ShortcutPickerHelper$OnPickListener;
    }
.end annotation
...
.field private mListener:Lorg/slim/utils/ShortcutPickerHelper$OnPickListener;
...
# direct methods
.method public constructor <init>(Landroid/app/Activity;Lorg/slim/utils/ShortcutPickerHelper$OnPickListener;)V
    .locals 1
    .param p1, "parent"    # Landroid/app/Activity;
    .param p2, "listener"    # Lorg/slim/utils/ShortcutPickerHelper$OnPickListener;
    ...
    .line 53
    iput-object p1, p0, Lorg/slim/utils/ShortcutPickerHelper;->mParent:Landroid/app/Activity;

    .line 54
    iget-object v0, p0, Lorg/slim/utils/ShortcutPickerHelper;->mParent:Landroid/app/Activity;

    invoke-virtual {v0}, Landroid/app/Activity;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v0

    iput-object v0, p0, Lorg/slim/utils/ShortcutPickerHelper;->mPackageManager:Landroid/content/pm/PackageManager;

    .line 55
    iput-object p2, p0, Lorg/slim/utils/ShortcutPickerHelper;->mListener:Lorg/slim/utils/ShortcutPickerHelper$OnPickListener;
...
.method private completeSetCustomApp(Landroid/content/Intent;)V
    ...
    .line 139
    iget-object v0, p0, Lorg/slim/utils/ShortcutPickerHelper;->mListener:Lorg/slim/utils/ShortcutPickerHelper$OnPickListener;
    ...
    .line 140
    iget-object v2, p0, Lorg/slim/utils/ShortcutPickerHelper;->mParent:Landroid/app/Activity;

    iget-object v3, p0, Lorg/slim/utils/ShortcutPickerHelper;->mPackageManager:Landroid/content/pm/PackageManager;

    invoke-static {v2, v3, p1, v4}, Lorg/slim/utils/AppHelper;->getFriendlyActivityName(Landroid/content/Context;Landroid/content/pm/PackageManager;Landroid/content/Intent;Z)Ljava/lang/String;
    ...
    .line 139
    invoke-interface {v0, v1, v2, v3, v4}, Lorg/slim/utils/ShortcutPickerHelper$OnPickListener;->shortcutPicked(Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;Z)V
...
.method private completeSetCustomShortcut(Landroid/content/Intent;)V
    ...
    iget-object v9, p0, Lorg/slim/utils/ShortcutPickerHelper;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    :cond_1
    :goto_0
    iget-object v9, p0, Lorg/slim/utils/ShortcutPickerHelper;->mListener:Lorg/slim/utils/ShortcutPickerHelper$OnPickListener;

    .line 174
    iget-object v10, p0, Lorg/slim/utils/ShortcutPickerHelper;->mParent:Landroid/app/Activity;

    iget-object v11, p0, Lorg/slim/utils/ShortcutPickerHelper;->mPackageManager:Landroid/content/pm/PackageManager;

    invoke-static {v10, v11, v7}, Lorg/slim/utils/AppHelper;->getFriendlyShortcutName(Landroid/content/Context;Landroid/content/pm/PackageManager;Landroid/content/Intent;)Ljava/lang/String;

    move-result-object v10

    .line 173
    invoke-interface {v9, v1, v10, v2, v12}, Lorg/slim/utils/ShortcutPickerHelper$OnPickListener;->shortcutPicked(Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;Z)V
...
.method private processShortcut(Landroid/content/Intent;II)V
    ...
    .line 123
    iget-object v4, p0, Lorg/slim/utils/ShortcutPickerHelper;->mParent:Landroid/app/Activity;
    ...
    .line 132
    invoke-direct {p0, v2, p2}, Lorg/slim/utils/ShortcutPickerHelper;->startFragmentOrActivity(Landroid/content/Intent;I)V
    ...
    .line 134
    :cond_0
    invoke-direct {p0, p1, p3}, Lorg/slim/utils/ShortcutPickerHelper;->startFragmentOrActivity(Landroid/content/Intent;I)V
...
.method private startFragmentOrActivity(Landroid/content/Intent;I)V
    ...
    .prologue
    .line 110
    iget v1, p0, Lorg/slim/utils/ShortcutPickerHelper;->lastFragmentId:I

    if-nez v1, :cond_1

    .line 111
    iget-object v1, p0, Lorg/slim/utils/ShortcutPickerHelper;->mParent:Landroid/app/Activity;
    ...
    iget v2, p0, Lorg/slim/utils/ShortcutPickerHelper;->lastFragmentId:I
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 62
    :pswitch_0
    invoke-direct {p0, p3}, Lorg/slim/utils/ShortcutPickerHelper;->completeSetCustomApp(Landroid/content/Intent;)V

    goto :goto_0

    .line 65
    :pswitch_1
    invoke-direct {p0, p3}, Lorg/slim/utils/ShortcutPickerHelper;->completeSetCustomShortcut(Landroid/content/Intent;)V
    ...
    invoke-direct {p0, p3, v0, v1}, Lorg/slim/utils/ShortcutPickerHelper;->processShortcut(Landroid/content/Intent;II)V
...
.method public pickShortcut(I)V
    ...
    invoke-virtual {p0, p1, v0}, Lorg/slim/utils/ShortcutPickerHelper;->pickShortcut(IZ)V
...
.method public pickShortcut(IZ)V
    ...
    .prologue
    .line 79
    iput p1, p0, Lorg/slim/utils/ShortcutPickerHelper;->lastFragmentId:I
    ...
    invoke-direct {p0, v2, v5}, Lorg/slim/utils/ShortcutPickerHelper;->startFragmentOrActivity(Landroid/content/Intent;I)V
    ...
    iget-object v5, p0, Lorg/slim/utils/ShortcutPickerHelper;->mParent:Landroid/app/Activity;
    ...
    iget-object v6, p0, Lorg/slim/utils/ShortcutPickerHelper;->mParent:Landroid/app/Activity;
