...
.method doHandleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v2, v3, v9, v6, v7}, Lcom/android/server/pm/PackageManagerService;->-wrap36(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;ZLjava/util/ArrayList;I)V
    ...
    .line 1368
    invoke-static {v2, v3, v6, v7}, Lcom/android/server/pm/PackageManagerService;->-wrap25(Lcom/android/server/pm/PackageManagerService;Landroid/content/pm/PackageParser$Package;I[Ljava/lang/String;)V
    ...
    .line 1428
    invoke-static/range {v9 .. v14}, Lcom/android/server/pm/PackageManagerService;->-wrap37(Lcom/android/server/pm/PackageManagerService;ZZLjava/util/ArrayList;[ILandroid/content/IIntentReceiver;)V
    ...
    .line 1456
    invoke-virtual {v2, v3, v6, v7}, Landroid/app/AppOpsManager;->setPrivacyGuardSettingForPackage(ILjava/lang/String;Z)V

    goto/16 :goto_e

    .line 1451
    .end local v39    # "privacyGuard":Z
    :cond_28
    const/16 v39, 0x0

    .restart local v39    # "privacyGuard":Z
    goto :goto_f
    ...
    invoke-static {v2, v0}, Lcom/android/server/pm/PackageManagerService;->-wrap39(Lcom/android/server/pm/PackageManagerService;Ljava/util/Set;)V
    ...
    .line 1528
    .restart local v54    # "userId$iterator":Ljava/util/Iterator;
    :cond_2e
    :try_start_a
    move-object/from16 v0, p0
    ...
    invoke-static {v2, v0, v1, v6, v3}, Lcom/android/server/pm/PackageManagerService;->-wrap22(Lcom/android/server/pm/PackageManagerService;ILandroid/net/Uri;ILandroid/os/UserHandle;)V
    ...
    invoke-static {v2, v0, v1, v3, v6}, Lcom/android/server/pm/PackageManagerService;->-wrap22(Lcom/android/server/pm/PackageManagerService;ILandroid/net/Uri;ILandroid/os/UserHandle;)V
    ...
    .end local v17    # "args":Lcom/android/server/pm/PackageManagerService$InstallArgs;
    .end local v33    # "originUri":Landroid/net/Uri;
    .end local v44    # "response":Lcom/android/server/pm/PackageVerificationResponse;
    .end local v45    # "ret":I
    .end local v48    # "state":Lcom/android/server/pm/PackageVerificationState;
    .end local v56    # "verificationId":I
    :pswitch_e
    ...
    .line 1610
    invoke-static {v2, v3, v6, v7, v9}, Lcom/android/server/pm/PackageManagerService;->-wrap43(Lcom/android/server/pm/PackageManagerService;IIZLandroid/content/pm/PackageParser$Package;)V
    ...
    .line 1619
    .local v47, "state":Lcom/android/server/pm/IntentFilterVerificationState;
    if-nez v47, :cond_32
